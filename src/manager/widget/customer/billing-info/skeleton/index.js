...
const {
  customerBox, radioButtons, headerBox, messageBock, locationSearch, actionButtons, customerHeader
} = require("../../../skeleton")
...
module.exports = function (ui) {
  ...
  const customer = Skeletons.Box.Y({
    ...
    kids: [
      ...
      actionButtons(ui, [
        { sys_pn: "btn-create", service: "bind-address", content: "Créer adresse de facturation", state: 0 },
        { sys_pn: "btn-create", service: "same-address", content: "Même adresse de facturation", state: 1 }
      ]),
    ]
  });


  let title = "Créer une adresse de facturation";
  if (isUpdate) {
    title = "Mettre à une adresse de facturation"
  }
