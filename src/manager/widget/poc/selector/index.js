...
class __poc_selector extends Form {
  ...
  loadForm() {
    this.ensurePart("entries-manual").then((p) => {
      p.feed(require('./skeleton/poc')(this))
    })
  }
  ...
  onUiEvent(cmd, args = {}) {
    ...
    switch (service) {
      ...
      case _a.input:
        ...
        break;
      case 'poc-selected':
        this.triggerHandlers({ service: this.mget('callbackService'), data: cmd.data() })
        break;
      default:
